...
!pip install numpy==1.26.4 opencv-python-headless==4.8.0.76 gradio pdfplumber spacy gtts fer speechrecognition docx2txt --upgrade --quiet
import gradio as gr
...
⚠️ Signs of **anger ({anger_frames} frames)** and **tension ({fear_frames} frames)** were noticed — try to relax and stay positive.
...
def analyze_and_feedback():
    status = "📽️ Processing video... generating feedback..."
    ...
    with gr.Tab("🎥 Interview"):
        with gr.Row():
            ...
            with gr.Column():
                ...
                start_btn = gr.Button("➡️ Start Interview")
